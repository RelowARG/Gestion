// software-gestion/src/preload.js (Modificado para incluir el token en apiRequest, la EXPORTACIÓN, exponer addVentaX y la IP del servidor)
const { contextBridge, ipcRenderer } = require('electron');

// MODIFICACIÓN: Define la URL base de tu backend API con la IP del servidor
const API_BASE_URL = 'http://192.168.0.7:3001/api'; // ASEGÚRATE QUE ESTA URL ES CORRECTA Y ES LA IP DE TU SERVIDOR BACKEND
